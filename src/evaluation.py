...
def main():
    ...
    # device option removed; rely on model's internal device_map
    args, _ = parser.parse_known_args()

    parquet_file_path = args.parquet_file
    model_output_column = args.model_output_column
    # device removed; rely on model's internal device_map
    ...
    output_filename = os.path.join(
        output_dir, f"{input_filename}_comprehensive_results.json"
    )
