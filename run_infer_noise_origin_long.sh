...
run_cmd "Gemma3n with noise" bash -c "CUDA_VISIBLE_DEVICES=$1 uv run src/inference.py --model gemma3n --noise-path ./assets/white-noise-358382-1m.mp3 --batch-size 1"
