...
run_cmd "Eval Qwen2.5-Omni audio" bash -c "CUDA_VISIBLE_DEVICES=$1 .venv-eval/bin/python src/evaluation.py results/qwen25-omni_predictions_audio.parquet --model_output_column model_response"s
