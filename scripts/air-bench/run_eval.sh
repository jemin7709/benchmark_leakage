...
run_cmd "Eval Qwen3-Omni-Thinking audio" bash -c "CUDA_VISIBLE_DEVICES=$1 .venv-eval/bin/python src/air-bench/foundation_scoring.py --input results/air-bench/qwen3-omni-thinking_predictions_foundation_audio.jsonl"
run_cmd "Eval Qwen3-Omni-Instruct audio" bash -c "CUDA_VISIBLE_DEVICES=$1 .venv-eval/bin/python src/air-bench/foundation_scoring.py --input results/air-bench/qwen3-omni-instruction_predictions_foundation_audio.jsonl"
